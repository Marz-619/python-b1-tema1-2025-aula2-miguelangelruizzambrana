...
def mult_recursive(value, times):
    if times==1: #Si la multiplicación es por 1, el valor es el propio value
        return value
    else:
        #Para más repeticiones, devuelvo el valor y vuelvo a llamar a la fucnión con 1 iteracion menos
